...
// Do not use. Temporary workaround, for source-code compatibility.
#define TfLiteOperatorCreateWithData(builtin_code, custom_name, version, \
                                     user_data)                          \
  TfLiteOperatorCreate(builtin_code, custom_name, version, user_data)
