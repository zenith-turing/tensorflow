...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    # tf_http_archive(
    #     name = "grpc",
    #     sha256 = "5c637846a3b082c325fc3798b0105177819895feb64dd751a6b4acd40ed86dfd",
    #     strip_prefix = "grpc-f8cfe1c16dc268ea4a8054851367a6deaa613a2a",
    #     system_build_file = clean_dep("//third_party/systemlibs:grpc.BUILD"),
    #     urls = [
    #         "https://storage.googleapis.com/mirror.tensorflow.org/github.com/grpc/grpc/archive/f8cfe1c16dc268ea4a8054851367a6deaa613a2a.tar.gz",
    #         "https://github.com/grpc/grpc/archive/f8cfe1c16dc268ea4a8054851367a6deaa613a2a.tar.gz",
    #     ],
    # )
    ...
    tf_http_archive(
        ...
        sha256 = "22ac7f8d6d9ccfa51d98d97df5d669dfa0f0568e0c5a1ade42aca1fb8990a72e",
        strip_prefix = "llvm-project-7a7e03f906aada0cf4b749b51213fe5784eeff84",
        urls = [
            "https://github.com/llvm/llvm-project/archive/7a7e03f906aada0cf4b749b51213fe5784eeff84.tar.gz",
